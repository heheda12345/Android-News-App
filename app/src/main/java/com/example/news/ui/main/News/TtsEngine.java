...
public class TtsEngine extends Activity implements OnClickListener {
    private static String LOG_TAG = TtsEngine.class.getSimpleName();
    // 语音合成对象
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initLayout();
        // 初始化合成对象
        mTts = SpeechSynthesizer.createSynthesizer(TtsEngine.this, mTtsInitListener);
...
//        mSharedPreferences = getSharedPreferences(TtsSettings.PREFER_NAME, MODE_PRIVATE);
    ...
    private void initLayout() {
        findViewById(R.id.tts_play).setOnClickListener(TtsEngine.this);
        findViewById(R.id.tts_cancel).setOnClickListener(TtsEngine.this);
        findViewById(R.id.tts_pause).setOnClickListener(TtsEngine.this);
        findViewById(R.id.tts_resume).setOnClickListener(TtsEngine.this);
        findViewById(R.id.image_tts_set).setOnClickListener(TtsEngine.this);
        findViewById(R.id.tts_btn_person_select).setOnClickListener(TtsEngine.this);
...
//			*/
    ...
    private SynthesizerListener mTtsListener = new SynthesizerListener() {
        ...
        public void onSpeakProgress(int percent, int beginPos, int endPos) {
            ...
            Log.e(LOG_TAG,"beginPos = "+beginPos +"  endPos = "+endPos);
